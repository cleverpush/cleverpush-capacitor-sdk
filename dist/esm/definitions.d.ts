...
export interface CleverPushCapacitorPlugin {
    ...
    addListener(eventName: 'notificationReceivedListener', listenerFunc: (data: {
        success: boolean;
        data?: any;
        error?: any;
    }) => void): Promise<PluginListenerHandle> & PluginListenerHandle;
    addListener(eventName: 'notificationOpenedListener', listenerFunc: (data: {
        success: boolean;
        data?: any;
        error?: any;
    }) => void): Promise<PluginListenerHandle> & PluginListenerHandle;
    addListener(eventName: 'appBannerOpenedListener', listenerFunc: (data: {
        success: boolean;
        data?: any;
        error?: any;
    }) => void): Promise<PluginListenerHandle> & PluginListenerHandle;
    addListener(eventName: 'subscribedListener', listenerFunc: (data: {
        success: boolean;
        data?: any;
        error?: any;
    }) => void): Promise<PluginListenerHandle> & PluginListenerHandle;
